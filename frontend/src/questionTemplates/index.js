...
const wf1mod2relevantExpanded = require('./wf1mod2_relevant_expanded.json');
const wf1mod3V2 = require('./wf1mod3_v2.json');
const wf1mod3 = require('./wf1mod3.json');
const wf2mod1aV2 = require('./wf2mod1a_v2.json');
const wf2mod1a = require('./wf2mod1a.json');
const wf2mod1dV2 = require('./wf2mod1d_v2.json');
const wf2mod1d = require('./wf2mod1d.json');
