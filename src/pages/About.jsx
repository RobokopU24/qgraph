    ...
    <Grid style={{ marginBottom: '50px' }}>
      <Row>
        <Col md={8}>
          ...
          <p>Query results are in the form of knowledge subgraphs or answers that match the categories and desired properties of the nodes and edges. In the Knowledge Graph Bubble, the size of each &lsquo;bubble&rsquo; represents how relatively common that entity is represented among the full answer set.</p>
          <hr />
